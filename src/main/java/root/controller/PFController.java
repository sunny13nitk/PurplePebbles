...
public class PFController
{
	...
	@GetMapping("/sellStockinPF")
	public String showSellStockinPF(
	        @RequestParam("pid") int pid, @RequestParam("scCode") String scCode, Model model
	)
	{
	...
	@GetMapping("/assignFLConfirm")
	public String confirmAssignFL(
	        @RequestParam("flid") int flid, @RequestParam("pid") int pid, Model model
	)
	{
	 ...
	 * ----------------- POST MAPPINGS ----------------------
	 */
	@PostMapping("/processCreatePF")
	public String processCreatePF(
	        @Valid @ModelAttribute("newPF") Portfolio newPf, BindingResult bRes, Model model
	)
	{
	...
	@PostMapping("/processUpdatePF")
	public String processUpdatePF(
	        @Valid @ModelAttribute("PF") Portfolio Pf, BindingResult bRes, Model model
	)
	{
	...
	@PostMapping("/processPFTxn")
	public String processPFTxn(
	        @Valid @ModelAttribute("newTxn") Trade trade, BindingResult bRes, Model model
	)
	{

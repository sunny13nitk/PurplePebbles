...
public class FLController
{
	...
	public String processdeletePF(
	        @RequestParam("flid") int flid, Model model
	)
	{
	 ...
	 * ----------------- POST MAPPINGS ----------------------
	 */
	@PostMapping("/processCreateFL")
	public String processCreateFL(
	        @Valid @ModelAttribute("newFL") FundLine newfl, BindingResult bRes, Model model
	)
	{
	...
	@PostMapping("/processCreateFLI")
	public String processaddFLItem(
	        @Valid @ModelAttribute("newFLI") FundLineItem newfli, BindingResult bRes, Model model
	)
	{
